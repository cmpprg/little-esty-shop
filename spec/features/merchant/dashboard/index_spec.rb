...
RSpec.describe 'As a merchant.', type: :feature do
  describe 'When I visit my dashboard.' do 
    ...
    it 'I see the names of the top 5 customers, who have the largest number of
        successful transactions with me.' do
      ...
      def create_necessary_resources(merchant, customer, result)
      ...
      # order in DB.
      7.times { create_necessary_resources(merchant, customer_2, 'success') }
      6.times { create_necessary_resources(merchant, customer_1, 'success') }
      5.times { create_necessary_resources(merchant, customer_3, 'success') }
      4.times { create_necessary_resources(merchant, customer_4, 'success') }
      3.times { create_necessary_resources(merchant, customer_5, 'success') }
      2.times { create_necessary_resources(merchant, customer_6, 'success') }
      1.times { create_necessary_resources(merchant, customer_7, 'success') }
      # I want to ensure that no failed transactions are counted
      2.times do 
        create_necessary_resources(merchant, customer_1, 'failed')
        create_necessary_resources(merchant, customer_2, 'failed')
        create_necessary_resources(merchant, customer_3, 'failed')
        create_necessary_resources(merchant, customer_4, 'failed')
        create_necessary_resources(merchant, customer_5, 'failed')
      end
